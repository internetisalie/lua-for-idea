...
import static com.sylvanaar.idea.Lua.lang.lexer.LuaTokenTypes.NEWLINE;
import static com.sylvanaar.idea.Lua.lang.lexer.LuaTokenTypes.SHORTCOMMENT;
...
//      } else if (myChild2.getPsi() instanceof LuaBlock) {
...
//      if (myChild2.getElementType() == ELSE) {
//        if (myChild1.getElementType() != BLOCK && myChild1.getElementType() != BLOCK_STATEMENT) {
...
//    }
    ...
    private void createSpacingBeforeElementInsideControlStatement() {
      if (mySettings.KEEP_CONTROL_STATEMENT_IN_ONE_LINE && myChild1.getElementType() != SHORTCOMMENT) {
        createSpaceProperty(true, mySettings.KEEP_LINE_BREAKS, mySettings.KEEP_BLANK_LINES_IN_CODE);
      } else {
        myResult = Spacing.createSpacing(1, 1, 1, mySettings.KEEP_LINE_BREAKS, mySettings.KEEP_BLANK_LINES_IN_CODE);
      }
