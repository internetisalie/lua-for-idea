 ...
 */
package com.sylvanaar.idea.Lua.lang.smartEnter;
...
import com.sylvanaar.idea.Lua.lang.smartEnter.processors.LuaPlainEnterProcessor;
...
public class LuaSmartEnterProcessor extends SmartEnterProcessor {
  ...
  private static final Logger LOG = Logger.getInstance("#LuaSmartEnterProcessor");
...
//
////    ourFixers = null; //fixers.toArray(new GrFixer[fixers.size()]);
//
